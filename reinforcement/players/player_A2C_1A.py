from players.player_A2C_1 import *
...
class player_A2C_1A( player_A2C_1 ):
    ...
    def network( self ):
        ...
        self.brain.addLayer( input = 'Observation', type = tb.layers.fully, out_channels =512,
                             activation = tb.activs.elu )

        self.brain.addLayer( type = tb.layers.fully, out_channels = 512,
                             activation = tb.activs.elu )

        self.brain.addLayer( out_channels = 1,
                             activation = None , name = 'Value' )
