from players.player_reinforce_rnn_1 import *
...
class player_reinforce_rnn_1A( player_reinforce_rnn_1 ):
    ...
    def network( self ):
        ...
        self.brain.addLayer( type = tb.layers.rnn, cell_type  = 'LSTM',
        ...
        self.brain.addLayer( type = tb.layers.fully, out_channels = 32 ,
